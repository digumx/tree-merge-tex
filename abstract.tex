...
automated driving, medical diagnosis, and air-traffic control.
These advancements make the utilization of these DNNs in embedded systems 
highly appealing. However, two challenges arise:
1. The inference process of DNNs on resource-limited embedded 
devices can often be time-consuming. 
2. Proving their trustworthiness for safety critical settings, typically using 
formal verification or formal explainability, is difficult.
Both of these challenges stem from the size of the DNNs. 
Their large size necessitates significant resources for decision-making,
which poses a problem in resource-limited embedded systems.
Also since real-world networks are trained for performance ,
