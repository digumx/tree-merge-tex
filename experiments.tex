...
`adv-unsafe' refers to adversarial properties from \cite{cegar-nn}. \todo{Decide
if to remove last 2 cols}}
\label{t:acas-verif}
\end{table}
...
account the larger semantic context of each refinement step. \todo{Discuss: does
this make sense?}
...
verification time. \todo{Discuss: Should we bring this into focus? Given changed
picture of experiment section, does stressing on this make sense?}
