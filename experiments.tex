...
Figures \ref{f:mnist-prop-samples}, Figures \ref{f:mnist-prop-pgd} and Table \ref{t:mnist-prop-summary} were produced on a 
...
\hline
\end{tabular}
\caption{Summary of \mnist compression Results \todo{Show false positive rate
instead of accuracy. Make changes in expl.}}
