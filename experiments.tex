...
ran on a machine running on an Intel(R) Core(TM) i7-9700K with 8 cpus running at
3.60GHz, having 16 GB ram and running Ubuntu 22.04 LTS. The results in
\ref{f:mnist-class} was produced in \todo{Madhukar's machine}.
...
compression-with-guarantees via some experiments on \mnist. We set the class '0'
