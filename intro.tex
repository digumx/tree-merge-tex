...
\dmcmt{I felt that here talking leading with embedded angle could be slightly
confusing, so I am leading with the formal analysis angle.} 
...
\dmcmt{Should I keep this here?}} which prevents these techniques from being
