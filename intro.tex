...
\abs. \cite{cegar-nn}. 
\dmcmt{This is instead of saying that they
don't guarantee \abs smaller than \cnc. I am not saying that since we don't
guarantee / demonstrate that either. Is that okay?}
In fact, in \cite{cegar-nn}, the \abs produced was sometimes observed to be
larger than the original \cnc. \dmcmt{Should we mention this? Maybe a footnote?
Note that \cite{cegar-nn} does explicitly say that this is the case.}
