...
%In the tree produced in the previous Section \ref{s:tree}, each node corresponds
%to a group of neurons that may be merged. Thus, given a cut of the tree, we
%can use it to define a merge 
...
neurons should remain merged. Intuitively, we wish for this choice to be guided
two factors: the semantic behavior of each node, and the point $\vct{\beta}$.
...
Any cut of the tree correspond produces a set of trees. Then,  
