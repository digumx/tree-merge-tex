...
\todo{Write as a lemma. Make notation clear. Intro notation for leaves being a
part of the tree in \ref{s:tree}}
...
\todo{Since semantic closeness doesn't actually anything concrete and
    quantitative about what happens at the output, this optimality is not able
to claim anything about output values. Discuss this, consider pushing parts of
this to future work}
