...
\begin{figure}
    \centering
    \includegraphics[width = 0.5\textwidth]{diagrams/_before and after cut.pdf }
...
\todo{Add the 3 different methods generating counter-examples. Scores should be avg over $\beta$ for a particular $\gamma$.}
