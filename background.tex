...
which we as the number of \textit{\gencex} that witness a difference in
...
formal analysis, there may be too many \gencex. In such
situations, a common approach to obtain a better quality \abs is to perform
refinement steps based on a \gencex$x$ \cite{cegar-nn,
