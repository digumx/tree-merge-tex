...
which we as the number of \textit{spurious points} that witness a difference in
the relevant behavior of \abs and \cnc. In the context of using \abs to
accelerate formal analysis of \dnn, these spurious points may simply be
...
\subsection{Semantic Neural Network Splitting and Merging}
\label{s:nn-sam}
...
\subsection{ Quality of Abstraction and Refinement }
...
While the fully merged network obtained in Section \ref{s:nn-sam} provides
strong guarantees, it may not be strong enough to be useful
